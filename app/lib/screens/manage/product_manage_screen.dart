...
class _ProductManageScreenState extends State<ProductManageScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            _searchQuery.isNotEmpty ? 'Không tìm thấy sản phẩm' : 'Chưa có sản phẩm',
                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate(
                        (ctx, i) => Padding(
                          ...
                          child: _ProductTile(
                            product: filtered[i],
                            onEdit: () => _showProductDialog(context, filtered[i]),
                            onHide: () async {
                              await provider.deleteProduct(filtered[i].id);
                              if (ctx.mounted) {
                                ScaffoldMessenger.of(ctx).showSnackBar(
                                  SnackBar(content: Text('Đã ẩn "${filtered[i].name}"')),
                                );
                              }
                            },
                          ),
      ...
      floatingActionButton: _AddFab(onTap: () => _showProductDialog(context, null), cs: cs),
    );
  }
}
...
class _FilterChip extends StatelessWidget {
  ...
  const _FilterChip({required this.label, required this.isActive, required this.onTap, required this.cs});
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: isActive ? cs.primary : const Color(0xFFC3C6D7)),
        ),
        child: Text(
          label,
          style: TextStyle(
...
class _ProductTile extends StatelessWidget {
  ...
  const _ProductTile({required this.product, required this.onEdit, required this.onHide});
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            const Text('Thêm món', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: Colors.white)),
          ],
        ),
      ),
    );
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Tên món *', hintText: 'Cà phê đen đá...'),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Giá (đồng) *', suffixText: 'đ'),
              validator: (v) {
              ...
              children: [
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'Đơn vị', hintText: 'ly, cái...'),
                  ),
                ),
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'Nhóm', hintText: 'Đồ uống...'),
                  ),
                ),
              ],
            ),
            ...
            SizedBox(
              ...
              child: FilledButton(
                ...
                child: _saving
                    ...
                    : Text(isEdit ? 'Lưu thay đổi' : 'Thêm món', style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
              ),
            ),
          ],
        ),
